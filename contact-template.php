...
/* ═══════════════════════════════════════════════════════════════
   CONFIGURACIÓN
   ════════════════════════════════════════════════════════════ */
$google_maps_embed = 'https://maps.google.com/maps?q=400+Portway+Ave+Suite+300%2C+Hood+River%2C+OR+97031&z=15&output=embed';
      ...
      <div class="ct-main__grid">
        ...
        <div class="ct-info">
          ...
          <div class="ct-details">
            ...
            $details = [
              ...
              [ 'label' => 'Address',       'value' => '<a href="https://www.google.com/maps/search/?api=1&query=400+Portway+Ave+Suite+300%2C+Hood+River%2C+OR+97031" target="_blank" rel="noopener noreferrer">400 Portway Ave Suite 300, Hood River, OR 97031</a>', 'icon' => '<path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/>' ],
        ...
        <div class="ct-map">
          <?php if($google_maps_embed): ?>
            <iframe src="<?= esc_url($google_maps_embed) ?>" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" title="AR Roofing — 400 Portway Ave Suite 300, Hood River, OR 97031"></iframe>
          <?php else: ?>
